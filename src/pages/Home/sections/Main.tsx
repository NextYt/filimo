...
const Main = () => {
  ...
  useEffect(() => {
    const details = currentCategory === 'Movie' ? featuredMovieDetail : featuredSeriesDetail;
  ...
  }, [currentCategory, activePosterIndex, featuredMovieDetail, featuredSeriesDetail]);
