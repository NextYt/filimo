...
const Footer = () => {
  ...
  const footerLinks = useContentSelector(
    (context) => context.state.footerLinks || []
  );
  const socialMedia = useContentSelector(
    (context) => context.state.socialMedia || []
  );
                ...
                <div className="hidden-menu hidden-menu-footer">
                  <ul className="hidden-menu-nav-footer">
                    {link.dropdownLinks.map((dropdownLink, dropdownIndex) => (
                      <li
                        key={dropdownIndex}
                        className="hidden-menu-item-footer"
                      >
            ...
            <div className="hidden-menu hidden-menu-footer">
              <ul className="hidden-menu-nav-footer">
                {socialMedia.map((social, index) => (
                  <li
                    key={index}
                    className="hidden-menu-item hidden-menu-item-footer"
                  >
